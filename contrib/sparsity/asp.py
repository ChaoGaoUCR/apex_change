...
class ASP:
    ...
    @classmethod
    def compute_sparse_masks(cls, important_score = "Magnitude"):
        ...
        if important_score == "Magnitude":        
            with torch.no_grad():
                ...
                for module_name, module, p_name, p, mask, pruned in cls.__sparse_parameters:
                    # print("check Line 243 bool value")
                    # breakpoint()
                ...
                # breakpoint()
        elif important_score == "Taylor":
            pass
        else:
            raise ValueError("Important Score wrong")
    @classmethod
    ...
    @classmethod
    def prune_trained_model(cls, model, optimizer, important_score = "Magnitude"):
        ...
        if important_score == "Magnitude":
            ...
            cls.compute_sparse_masks(important_score="Taylor")
        else:
            raise ValueError("Important Score wrong")
